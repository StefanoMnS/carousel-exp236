...
`
  ...
  return {
    ...
    addBanner: function (sparksOptions) {
      ...
      <img width="94" height="130" src=""/>
      <section class="carousel__footer">
      <p>View bag</p><svg width="24" height="22" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M21.883 12l-7.527 6.235.644.765 9-7.521-9-7.479-.645.764 7.529 6.236h-21.884v1h21.883z" transform: translateY(2px);/>
      </svg>
      </section>
      </li>
      <li class="card" data-target="card">
...
window.addEventListener('load', function () {
  ...
  const sparkCards = [{
    ...
    type: 'viewBag',
    footer: 'View bag',
    image: 'https://asset1.marksandspencer.com/is/image/mands/PL_05_T35_2002D_Z0_X_EC_0?$PDP_REC_CAR_LG$',
    width: 94,
    height: 130
  }, {
    ...
    type: 'viewOrder',
    footer: 'View order',
    image: 'https://asset1.marksandspencer.com/is/image/mands/PL_05_T35_5005D_Z0_X_EC_0?$PDP_REC_CAR_LG$',
    width: 94,
    height: 130
  }, {
    ...
    type: 'seeAll',
    footer: 'See all',
    image: 'https://asset1.marksandspencer.com/is/image/mands/PL_05_T35_5481D_Z0_X_EC_0?$PDP_REC_CAR_LG$',
    width: 94,
    height: 130
  }]
